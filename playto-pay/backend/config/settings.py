...
ALLOWED_HOSTS = env.list('ALLOWED_HOSTS', default=['localhost', '127.0.0.1', 'playto-pay.onrender.com', '*'])
...
EMAIL_HOST_USER = env('EMAIL_HOST_USER', default='vishalsuresh1975@gmail.com')
EMAIL_HOST_PASSWORD = env('EMAIL_HOST_PASSWORD', default='eeddbdutibkaeahz')
DEFAULT_FROM_EMAIL = env('DEFAULT_FROM_EMAIL', default='Playto Pay <vishalsuresh1975@gmail.com>')